...
function _update()
  ...
  if btn(8) then camera.yaw = camera.yaw + 0.01 end
  if btn(9) then camera.yaw = camera.yaw - 0.01 end
  if btn(10) then camera.pitch = camera.pitch + 0.01 end
  if btn(11) then camera.pitch = camera.pitch - 0.01 end
